...
6. MCP INTEGRATION: You have access to external tools via Model Context Protocol (MCP). Use them to extend your capabilities (e.g., system specialized tools, database access, or external APIs).
